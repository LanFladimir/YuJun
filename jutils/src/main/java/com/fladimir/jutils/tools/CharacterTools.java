...
public class CharacterTools {
	...
	private static CharacterTools appcharacterParser = new CharacterTools();
	...
	//单例对象
	public static CharacterTools getAppCharacterParserInstance() {
	...
	private int getChsAscii(String chs) {
		...
		try {
			...
			e.printStackTrace();
			Log.e("CharacterTools", e.getMessage().toString());
		}
		return asc;
	}
